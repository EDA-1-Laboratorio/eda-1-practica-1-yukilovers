...
//Porque la matriz siguiente_mundo se ocupa como auxiliar para ir almacenando el nuevo mundo que se genera. Si actualizáramos directamente sobre la matriz mundo perderíamos los valores originales y no se estaría analizando el mundo actual por eso al terminar de generar el siguiente mundo es cuando se le debe de asignar a la matriz mundo los nuevos valores obtenidos.
